...
var $author$project$Model$PostIds$advance = function (_v0) {
	...
	return A2(
		...
		$author$project$Cursor$forward(cursor));
};
...
var $author$project$Model$Post$decode = A8(
	...
	A2(
		...
		function (seconds) {
			return $elm$time$Time$millisToPosix(seconds * 1000);
		},
...
var $author$project$Model$PostIds$decode = A2(
	...
	A2(
		...
		$elm$core$Maybe$map($author$project$Model$PostIds$PostIds)),
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					function (post) {
						return config.showJobs || (post.type_ !== 'job');
					},
					A2(
						$elm$core$List$filter,
						function (post) {
...
var $author$project$View$Posts$headerRow = A2(
	$elm$html$Html$tr,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		if (_Utils_cmp(
			...
			var totalSeconds = (($elm$time$Time$posixToMillis(t2) - $elm$time$Time$posixToMillis(t1)) / 1000) | 0;
			var remainingSecondsAfterDays = A2($elm$core$Basics$modBy, (24 * 60) * 60, totalSeconds);
			var remainingSecondsAfterHours = A2($elm$core$Basics$modBy, 60 * 60, remainingSecondsAfterDays);
			var seconds = A2($elm$core$Basics$modBy, 60, remainingSecondsAfterHours);
			var minutes = (remainingSecondsAfterHours / 60) | 0;
			var hours = (remainingSecondsAfterDays / (60 * 60)) | 0;
		...
		function (value, singular, plural) {
			switch (value) {
				case 0:
					return $elm$core$Maybe$Nothing;
				case 1:
					return $elm$core$Maybe$Just('1 ' + singular);
				default:
					return $elm$core$Maybe$Just(
						$elm$core$String$fromInt(value) + (' ' + plural));
			}
		});
	var hoursPart = A3(formatPart, duration.hours, 'hour', 'hours');
	var minutesPart = A3(formatPart, duration.minutes, 'minute', 'minutes');
	var secondsPart = A3(formatPart, duration.seconds, 'second', 'seconds');
	var daysPart = A3(formatPart, duration.days, 'day', 'days');
	var parts = A2(
...
var $author$project$Util$Time$formatDate = function (_v0) {
	var date = _v0.a;
	return $elm$core$String$fromInt(date.year) + (' ' + ($author$project$Util$Time$monthToString(date.month) + (' ' + A3(
...
var $author$project$Util$Time$formatTime = F2(
	function (tz, time) {
		...
		return $author$project$Util$Time$formatDate(date) + (' ' + (A3(
			$elm$core$String$padLeft,
			2,
			_Utils_chr('0'),
			$elm$core$String$fromInt(
				A2($elm$time$Time$toHour, tz, time))) + (':' + A3(
			$elm$core$String$padLeft,
			2,
			_Utils_chr('0'),
			$elm$core$String$fromInt(
...
var $author$project$View$Posts$postRow = F2(
	function (currentTime, post) {
		var formattedDate = A2($author$project$Util$Time$formatTime, $elm$time$Time$utc, post.time);
		var durationResult = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(formattedDate + (' (' + (durationResult + ')')))
						])),
					A2(
					$elm$html$Html$td,
					_List_fromArray(
...
var $author$project$View$Posts$postTable = F3(
	function (config, currentTime, posts) {
		var sortedPosts = A2(
			...
			$author$project$Model$PostsConfig$sortToCompareFn(config.sortBy),
			posts);
		var filteredPosts = A2($author$project$Model$PostsConfig$filterPosts, config, sortedPosts);
		return A2(
			$elm$html$Html$table,
			_List_Nil,
			A2(
				$elm$core$List$cons,
				$author$project$View$Posts$headerRow,
				A2(
					$elm$core$List$map,
...
var $author$project$View$Posts$postsConfigView = function (config) {
	var sortByOptions = _List_fromArray(
		['Score', 'Title', 'Posted', 'None']);
	var sortByOptionView = function (sortByString) {
		var isSelected = _Utils_eq(
			$author$project$Model$PostsConfig$sortToString(config.sortBy),
			sortByString);
		return A2(
			$elm$html$Html$option,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$value(sortByString),
					$elm$html$Html$Attributes$selected(isSelected)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(sortByString)
				]));
	};
	var postsToShowOptions = _List_fromArray(
		[10, 25, 50]);
	var postsToShowOptionView = function (number) {
		var isSelected = _Utils_eq(number, config.postsToShow);
		return A2(
			$elm$html$Html$option,
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Posts to show')
							])),
						A2(
							...
							[
								...
								A2(
									...
									A2(
										...
										A2($elm$core$Basics$composeR, $author$project$Model$PostsConfig$ChangePostsToShow, $author$project$Model$ConfigChanged))))
							]),
						A2($elm$core$List$map, postsToShowOptionView, postsToShowOptions))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Choose sorting method')
							])),
						A2(
						$elm$html$Html$select,
						_List_fromArray(
						...
						A2($elm$core$List$map, sortByOptionView, sortByOptions))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/Users/alinamacavei/Desktop/Elm-Project-4/tests/ExampleTests/CursorTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/ExampleTests/ModelPostIdsTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/ExampleTests/ModelPostsConfigTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/ExampleTests/UtilTimeTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/MainTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/PostsConfigTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/PostsViewTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/PostTests.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/SimulatedEffect.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/TestData.elm', '/Users/alinamacavei/Desktop/Elm-Project-4/tests/TestUtils.elm']),
		processes: 8,
...
var pipeFilename = "/tmp/elm_test-78020.sock";
var net = require('net'),
